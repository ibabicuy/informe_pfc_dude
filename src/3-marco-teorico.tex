...
PlatformIO incluso se encarga de mantener actualizadas las plataformas y librerías en su última versión. Hacer esto manualmente es una pérdida de tiempo. A continuación se muestra la vista de inicio de Atom con PlatformIO.~\qref{fig:atom-plat}
